...
public class SellerTechnology extends javax.swing.JFrame {

    private DefaultTableModel model;
    private Seller generatorData;
    private SellerInputGui auxData;
    private ArrayList<String> personalInfo;
    private ArrayList<Seller_TechnologyData> technology_struct;
    ...
    public SellerTechnology(Seller _generatorData, SellerInputGui _auxData) {
    ...
    public void defineTable(JTable table, ArrayList<Seller_TechnologyData> list) {
            ...
            if (jComboBox_Fuel.getSelectedIndex() != 0) {
                try {
                    ...
                    if ((minCap >= 0 && minCap < maxCap)) {
                        technology_struct.add(new Seller_TechnologyData(jComboBox_Technology.getSelectedItem().toString(), jComboBox_Fuel.getSelectedItem().toString(), minCap, maxCap));
                    } else {
    ...
    private void delete_update_PowerPlant(JTable table, ArrayList<Seller_TechnologyData> _list, boolean _isUpdate) {
