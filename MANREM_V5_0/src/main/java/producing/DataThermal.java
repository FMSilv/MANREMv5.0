 ...
 *
 * @author João
 * * Copied from DataThermal on scheduling package whose author was Afonso Mota Cardoso Neves da Silva 
 */
public class DataThermal{                                         
    ...
    public DataThermal(String GENCO_name,String ID, String Fuel, double MinP, double MaxP, double RU, double RD, double MinOn, double MinOff, double PrevProd,double FCost, double VCost, double SUcost,double SDcost, int initStatus, double FuelCfixed, double FuelCvar, double EmCO2, double EmNO2) throws MinMaxException, MediumValueException{
       if (MinP>=MaxP){
