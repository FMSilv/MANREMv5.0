...
//        private double[] deviation= Risk.deviation(PERIODS);
        ...
        private NegotiationManager(Producer a, String t, double[] ip, double[] mp, double[] en, String s, String s_algorithm, String pre, String riskpre, Date d, String c, double[] prices_sent_to_buyer, double[] profile_received_from_buyer) {
